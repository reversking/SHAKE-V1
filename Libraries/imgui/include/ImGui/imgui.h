...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChild(const char* str_id, ImTextureID image, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    IMGUI_API bool          BeginChild(ImGuiID id, ImTextureID image, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0), ImVec4 color = ImVec4(0.8745f, 0.1255f, 0.3020f, 1.0f), ImVec4 hover = ImVec4(0.8745f, 0.1255f, 0.3020f, 1.0f));

    IMGUI_API bool          SmallButton(const char* label);
    IMGUI_API bool          InvisibleButton(const char* str_id, const ImVec2& size, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ArrowButton(const char* str_id, ImGuiDir dir);
    IMGUI_API bool          Checkbox(const char* label, bool* v);
    IMGUI_API bool          Keybind(const char* label, int* key, bool show_label = true);
    IMGUI_API bool          qrCode(const char* label, ImTextureID image, const ImVec2& size, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          DiamondButton(const char* label, ImTextureID image, ImTextureID image_bg, bool selected, const ImVec2& size);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, float val, bool multi, ImGuiComboFlags flags = 0);
    IMGUI_API void          EndCombo();
    IMGUI_API bool          Combo(const char* label, int* current_item, const char* const items[], int items_count, int popup_max_height_in_items = -1, bool multi_select = false);
    IMGUI_API bool          Combo(const char* label, int* current_item, const char* items_separated_by_zeros, int popup_max_height_in_items = -1, bool multi_select = false);
    IMGUI_API bool          Combo(const char* label, int* current_item, bool(*items_getter)(void* data, int idx, const char** out_text), void* data, int items_count, int popup_max_height_in_items = -1, bool multi_select = false);
    ...
    IMGUI_API bool          SliderFloat(const char* label, float* v, float v_min, float v_max, const char* format = "%.1f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          InputText(const char* label, ImTextureID image, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    IMGUI_API bool          InputTextMultiline(const char* label, char* buf, size_t buf_size, const ImVec2& size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    IMGUI_API bool          InputTextWithHint(const char* label, ImTextureID image, const char* hint, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    ...
    IMGUI_API bool          BeginChildFrame(ImGuiID id, ImTextureID image, const ImVec2& size, ImGuiWindowFlags flags = 0);
