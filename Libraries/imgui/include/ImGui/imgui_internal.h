...
#define IM_DRAWLIST_CIRCLE_AUTO_SEGMENT_MIN                     504
...
namespace ImGui
{
	...
	IMGUI_API  bool         BeginChildEx(const char* name, ImTextureID image, ImGuiID id, const ImVec2& size_arg, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags);
    ...
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, ImVec4 color = ImVec4(0.8745f, 0.1255f, 0.3020f, 1.0f), ImVec4 hover = ImVec4(0.8745f, 0.1255f, 0.3020f, 1.0f));

    IMGUI_API bool DownloadNotification(const char* title, const char* description,
        const char* button1, const char* button2,
        const char* update_info, bool* p_open);
    IMGUI_API bool          Button_Icon(const char* label, ImTextureID image, bool selectable, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonTab(ImTextureID image, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Tab(const char* label, ImTextureID image, bool selectable, const ImVec2& size_arg);
    IMGUI_API bool          Switch(const char* label, bool selectable, const ImVec2& size_arg);
    IMGUI_API bool          Switch_Tab(const char* label, bool selectable, const ImVec2& size_arg);
    IMGUI_API bool          Image_Icon(const char* label, ImTextureID image, bool selectable, const ImVec2& size_arg);
    IMGUI_API bool          Name_Category(const char* label, ImTextureID image, bool selectable, const ImVec2& size_arg);
    IMGUI_API bool          ButtonTabBack(ImTextureID image, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          InfoTab(ImTextureID image, const char* label, const char* text, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Button_Login(const char* label, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonInject(ImTextureID image, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          SelectButton(ImTextureID image, ImColor condition, ImColor text_color, const char* label, const char* label_1, const char* text, const char* text_teg, const char* text_teg_1, const char* percent, float percent_circle, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          InputTextEx(const char* label, ImTextureID image, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
